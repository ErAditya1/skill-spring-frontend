        ...
        <MaxWidthWrapper>
          ...
          <div className="flex gap-4 justify-center mt-8">
            <Button asChild size="lg">
              <Link href="/auth/courses">Browse Courses</Link>
            </Button>
      ...
      <section className="py-20 bg-muted text-center">
        <MaxWidthWrapper>
          ...
          <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
            Create structured courses, upload lessons, manage students,
            and grow your income through our powerful instructor dashboard.
          </p>
